...
function displayRooms() {
    ...
    if (selectedHouse.owner == connectedUser) {
        btn = ` <a class="btn btn-primary mb-2 mt-0" style="color: white;" onclick="checkRooms(${selectedHouse.rooms})"> Add new room </a>  `;
    ...
    for (var i = 0; i < roomsTab.length; i++) {
        if (roomsTab[i].house == selectedHouseId) {
            content = content + ` 
               <div class="col-md-4 d-flex services align-self-stretch px-4 ftco-animate fadeInUp ftco-animated" style="margin-bottom: 2%;">
...
function deleteUserByAdmin(id) {
    ...
    for (var i = 0; i < reservations.length; i++) {
        if (reservations[i].ownerId == id || reservations[i].clientId == id) {
...
function search() {
    ...
    for (var i = 0; i < houses.length; i++) {
        if ((houses[i].houseName == search) || (houses[i].houseAddress == search)) {
            content = content + `
        <div class="col-md-4  services align-self-stretch py-4 px-4 ftco-animate fadeInUp ftco-animated" style="margin-bottom: 5%;">
            <div class="d-block services-wrap text-center align-self-stretch">
                <div class="media-body py-4 px-3">
                    <a href="houseDetails.html" class="block-20 rounded"
                        style="background-image: url('images/house.jpg');">
...
function displayMyReservations() {
    ...
    <button   class="btn btn-success ml-4">Pay</button>
    </div>`;
